...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Редактирование темы модуля "{{$chapter->title}}"</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        @if ($errors->any())
    ...
    <section class="content">
        <form method="post" action="{{ route('theme.update', $theme['id']) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input value="{{ $theme->title }}" name="title" type="text" class="form-control">
                            </div>
                ...
                <div class="col-md-6">
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label>Номер</label>
                                <input value="{{ $theme->order }}" name="order" type="number" class="form-control">
                            </div>
                        </div>
                        <!-- /.card-body -->
                    </div>
