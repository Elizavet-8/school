            ...
            <div id="pass" class="pass">
                <div style="margin-left:0; margin-right:0" class="row">
                    <div class="col-lg-4 pass-menu">
                        ...
                        <nav class="menu">
                            ...
                            <a class="menu_active_tab"
                               href="{{ route('theme.materials', [$theme['id'], $section['id']]) }}">Дополнительные
                                материалы по теме</a>
                            @if ($theme->is_tests($section['id']))
                                {{-- <a href="{{ url("/test/about/{$theme->tests->where('section_id', $section['id'])[0]['id']}")}}">Тест по теме</a>--}}
                                <a href="{{ route('theme.test', [$theme['id'], $section['id']]) }}">Тесты по теме</a>
                            @endif
                    ...
                    <div class="offset-lg-1 col-lg-7 materials-block">
                        <p class="tests-title">
                            {{$section->title}}. Дополнительные материалы по теме
                        </p>
                                ...
                                @foreach ($materials as $file)
                                    <div class="col-md-4">
                                        <a class="materials-item">
                                            <svg
                                                style="fill: #fabe4b; height:40px; min-height: 40px;align-self: flex-start;"
