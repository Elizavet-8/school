              ...
              <div style="margin-left:0; margin-right:0" class="row">
                 <div class="col-lg-4 pass-menu">
                    ...
                    <nav class="menu">
                     ...
                     <a class="menu_active_tab" href="{{ route('all.theme.test', [$theme['id']]) }}">Тесты по теме</a>
                     @endif
                       ...
                       <div style="margin-left:0; margin-right:0" class="row">
                        ...
                        <div class="col-md-4">
                            <a class="materials-item">
                              ...
                              <svg style="fill: #fabe4b; height:40px; min-height: 50px;align-self: flex-start;" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                              ...
                              <i class="fa fa-2x fa-check-circle" style="color: rgb(86, 197, 21)" aria-hidden="true"></i>
                              @endif
